...
window.HOMAGE_DATA = {
  originals: [
    ...
    },
    {
      ...
      homages: [
        { name: "PD-1645", house: "Pagani Design", priceUSD: 125, size_mm: 42, wr_m: 100, movement: "Automatic", fidelity: 72, priceSource: "paganidesign.com", priceDate: "2026-08-13", asin: "B0CWH4B3KJ", amazon: true, verified: "2026-08-13", note: "fluted bezel in two finishes, jubilee bracelet and cyclops date with sapphire and a 100m rating — but the case is a full 42mm against the original's 36mm, and no homage recovers six millimetres of proportion" },
        ...
        { name: "SN058", house: "San Martin", priceFrom: true, priceUSD: 326, size_mm: 36, wr_m: 100, movement: "Automatic (PT5000 / SW200)", fidelity: 85, priceSource: "sanmartinwatches.com", priceDate: "2026-08-30", amazon: false, direct: true, verified: "2026-08-30", note: "the one that nails the proportions the original is known for — 36mm and 11.9mm thin, on a five-link bracelet, with a carved bezel rather than a stamped one; a Swiss-class PT5000 or SW200 rather than the Seiko autos the budget tier runs. Direct-only: San Martin lists it in stock at $326 on 2026-08-30, and Amazon does not carry it — a search for the reference returns unrelated 1963-branded watches, so the shop link here is a plain unpaid one." },
      ]
    },
    {
