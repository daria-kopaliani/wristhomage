  ...
  originals: [
    {
      ...
      homages: [
        ...
        { name: "SN004-G", house: "San Martin", priceUSD: 238, size_mm: 38, wr_m: 200, movement: "Automatic (Seiko NH35)", fidelity: 85, priceSource: "sanmartinwatches.com", priceDate: "2026-08-13", amazon: false, direct: true, verified: "2026-09-21", note: "sharp finishing for the money and a well-cut ceramic bezel, though at 38mm it wears three millimetres under the original; re-checked 2026-09-21 and the movement split is not what this row used to say: the current SN004-G-V4 offers NH35, PT5000 and SW200 from one selector under a single reference, so the Swiss-class options are a configuration of the same watch rather than a separate reference. Only the older SN004-G-B is PT5000/SW200 alone. Every SN004 variant San Martin lists — V4, V5, V3, V2, B, A and the base — was out of stock on its own store at that same check." },
        ...
        { name: "SRPE74", house: "Seiko", priceUSD: 450, size_mm: 42.5, wr_m: 100, movement: "Automatic (Seiko 4R36)", fidelity: 58, priceSource: "seikowatches.com", priceDate: "2026-08-13", asin: "B08BMF5Z29", amazon: true, verified: "2026-08-13", note: "not a Sub copy — the spiritual budget diver the community reaches for instead, with its own identity and an in-house auto; note this reference is gold-tone throughout, so for the steel version of the same idea look to Seiko's SRPD series" },
        { name: "AD2078", house: "Addiesdive", priceUSD: 153, size_mm: 41, wr_m: 200, movement: "Automatic (Seiko NH35 / Miyota 8215)", fidelity: 77, priceSource: "amazon.com", priceDate: "2026-09-11", asin: "B0DX73XKQD", amazon: true, direct: true, verified: "2026-08-13", note: "a popular budget Sub homage at the original's 41mm — ceramic bezel, sapphire with the cyclops, 200m and a Seiko-class auto; carried on Amazon, often cheaper direct" }
      ]
    },
    {
    ...
    },
    {
      ...
      homages: [
        { name: "PD-1664", house: "Pagani Design", priceUSD: 104, size_mm: 40, wr_m: 100, movement: "Meca-quartz (Seiko VK63)", fidelity: 82, priceSource: "paganidesign.com", priceDate: "2026-08-13", asin: "B0H1RHXMH1", amazon: true, verified: "2026-08-13", note: "panda dial and tachymeter bezel with a snappy meca-quartz chrono — the seconds hand sweeps, the pushers feel mechanical, and it costs almost nothing; Pagani's own catalog files it in the Daytona family and it matches the original's 40mm exactly" },
        ...
        { name: "S465", house: "Sugess", priceUSD: 219, size_mm: 38, wr_m: 50, movement: "Mechanical chronograph (Seagull ST19)", fidelity: 76, priceSource: "sugesswatch.com", priceDate: "2026-08-13", asin: "B0FWS5BGZH", amazon: true, direct: true, verified: "2026-08-13", note: "for purists who want a hand-wound column-wheel chronograph instead of quartz — swan-neck regulator, blued screws and an exhibition caseback; it is a vintage-chronograph shape at 38mm rather than a line-for-line modern Daytona" }
      ]
    },
    {
      ...
      homages: [
        { name: "PD-1645", house: "Pagani Design", priceUSD: 125, size_mm: 42, wr_m: 100, movement: "Automatic", fidelity: 72, priceSource: "paganidesign.com", priceDate: "2026-08-13", asin: "B0CWH4B3KJ", amazon: true, amazonPriceUSD: 139.99, amazonPriceDate: "2026-09-22", availability: "in-stock", availabilityDate: "2026-09-22", availabilitySource: "amazon.com", verified: "2026-08-13", note: "fluted bezel in two finishes, jubilee bracelet and cyclops date with sapphire and a 100m rating — but the case is a full 42mm against the original's 36mm, and no homage recovers six millimetres of proportion" },
        { name: "C8053", house: "Cadisen", priceUSD: 80, size_mm: 38, wr_m: 50, movement: "Automatic (Miyota 8215)", fidelity: 76, priceSource: "cadisenwatch.com", priceDate: "2026-08-30", amazon: false, direct: true, directUrl: "https://www.cadisenwatch.com/cadisen-c8053", verified: "2026-08-30", note: "Cadisen's own catalog titles this one Datejust — fluted-look bezel, cyclops date and sapphire at 38mm, a size closer to the original than the Pagani's 40. Amazon search did not surface C8053, so this now links to Cadisen's exact, in-stock $79.99 product page instead of sending readers to unrelated watches. The direct link is not affiliated." },
        { name: "SN058", house: "San Martin", priceFrom: true, priceUSD: 326, size_mm: 36.5, wr_m: 100, movement: "Automatic (PT5000 / SW200)", fidelity: 85, priceSource: "sanmartinwatches.com", priceDate: "2026-08-30", amazon: false, direct: true, directUrl: "https://sanmartinwatches.com/shop/sn051-sn060/sn058/sn0058-g-x/", availability: "in-stock", availabilityDate: "2026-09-23", availabilitySource: "sanmartinwatches.com", availabilityConfig: "PT5000 \u00b7 Sunray Black \u00b7 with logo", availabilityConfigsInStock: 1, availabilityConfigsTotal: 24, availabilityExcludes: "every SW200 configuration", verified: "2026-09-23", note: "the one that nails the proportions the original is known for — 36.5mm and 11.9mm thin, on a five-link bracelet, with a carved bezel rather than a stamped one; a Swiss-class PT5000 or SW200 rather than the Seiko autos the budget tier runs. San Martin's own store lists it in stock at $326 on 2026-09-22. Amazon does now carry the same reference — a third-party listing, model number SN058-G-X, in stock at $399.90 on 2026-09-22 — but that is about $74 over what the maker charges, so the shop link here stays the plain unpaid one rather than the dearer paid one." },
      ]
    },
    {
      ...
      homages: [
        { name: "PD-1752", house: "Pagani Design", priceUSD: 135, size_mm: 36, wr_m: 100, movement: "Automatic day-date (Seagull ST16)", fidelity: 82, priceSource: "amazon.com", priceDate: "2026-09-11", asin: "B0DKNQFGFS", amazon: true, verified: "2026-08-13", note: "the one that keeps the 36mm President proportions — fluted bezel, president-style bracelet, day and date under sapphire, on a Seagull ST16 with a 100m rating" },
        { name: "PD-1783", house: "Pagani Design", priceUSD: 178, size_mm: 40, wr_m: 100, movement: "Automatic day-date (Seiko NH36A)", fidelity: 78, priceSource: "paganidesign.com", priceDate: "2026-08-13", asin: "B0CP5RMFN7", amazon: true, verified: "2026-08-13", note: "the modern 40mm take with a proper NH36A day-date auto and a 100m rating; wears larger and sportier than the classic 36" },
        { name: "C8185", house: "Cadisen", priceUSD: 104, size_mm: 40, wr_m: 100, movement: "Automatic day-date (Miyota 8285)", fidelity: 74, priceSource: "cadisenwatch.com", priceDate: "2026-08-13", asin: "B09LS4D8YL", amazon: true, verified: "2026-08-13", note: "Cadisen's presidential-style day-date on a genuine Miyota 8285, with a dial range the segment is famous for — full gold, meteorite white and Tiffany blue — plus sapphire and a 100m rating at 40mm" },
        { name: "RA-AA0C01B", house: "Orient", priceUSD: 245, size_mm: 41.9, wr_m: 50, movement: "Automatic (Orient F6922)", fidelity: 55, priceSource: "orientwatchusa.com", priceDate: "2026-08-13", asin: "B07YRXPBFD", amazon: true, verified: "2026-08-13", note: "not a President copy — the honest budget day-date automatic the community reaches for since the old Orient President left the catalog; own identity, an in-house auto and an exhibition caseback, filed by Orient itself under Contemporary rather than its diver line" }
      ]
    },
    {
      ...
      homages: [
        { name: "PD-1690", house: "Pagani Design", priceUSD: 152, size_mm: 40, wr_m: 200, movement: "Automatic (Miyota 8215)", fidelity: 86, priceSource: "paganidesign.com", priceDate: "2026-08-30", amazon: false, direct: true, directUrl: "https://paganidesign.com/products/pd-1690", availability: "sold-out", verified: "2026-08-30", note: "the turquoise-dial favourite that rode the Tiffany-OP craze — clean time-only dial, a real 200m rating and a Miyota 8215 auto, at 40mm against the original's 41. Pagani's official page confirms the reference and specifications but every variant is sold out; Amazon search did not surface PD-1690 either. The link now opens that exact official availability page instead of unrelated Amazon results and is not affiliated." },
    ...
    },
    {
      ...
      homages: [
        { name: "PD-1751", house: "Pagani Design", priceUSD: 140, size_mm: 36, wr_m: 200, movement: "Automatic (Seiko NH35)", fidelity: 76, priceSource: "amazon.com", priceDate: "2026-09-11", asin: "B0BZXN3D26", amazon: true, verified: "2026-08-18", note: "a clean 36mm three-hander with sapphire and a genuine 200m rating for around a hundred dollars; Pagani markets it as a Ranger homage rather than an Explorer one, and the 3-6-9 dial language serves both — read it as the shape rather than a line-for-line copy; every variant was sold out on Pagani's own store when we re-checked on 18 Aug 2026. Sold out in every variant on Pagani Design's own store at our 2026-08-28 check." },
        { name: "SN021-G", house: "San Martin", priceFrom: true, priceUSD: 299, size_mm: 37, wr_m: 100, movement: "Automatic (PT5000 / SW200)", fidelity: 86, priceSource: "sanmartinwatches.com", priceDate: "2026-08-12", amazon: false, direct: true, verified: "2026-09-21", note: "the community default for a 36mm Explorer: a Swiss-class PT5000 or SW200 rather than a Seiko auto, top-hat sapphire with AR, and 11mm thick so it wears like the original rather than a modern reissue. Corrected 2026-09-21: this row read 36mm because San Martin's product TITLE says 36mm. Its own specification block does not — it lists \"Bezel 36mm\" and \"37mm in diameter\", so 36 is the bezel and the case is 37. The Explorer 124270 is 36mm, so this wears a millimetre over the original rather than matching it exactly — a smaller gap than most of the field manages, but not the dead-on fit this row used to claim. The title is also where the B-series confusion came from: the B2 is titled 37MM because it quotes the diameter, not because it is a different size. Sold out in every variant on San Martin's own store at our 2026-09-21 check." },
        { name: "S4056", house: "Baltany", priceUSD: 220, size_mm: 36, wr_m: 200, movement: "Automatic (Seiko NH38)", fidelity: 76, priceSource: "baltany.com", priceDate: "2026-08-13", asin: "B0G5PW11SD", amazon: true, direct: true, verified: "2026-08-13", note: "a vintage-leaning 36mm that matches the original's case size exactly, with double its water resistance and a domed crystal; Baltany also sells a retro sibling, the S4066AB, at much the same money" },
        { name: "AD2556 Explorer Style", house: "Addiesdive", priceUSD: 150, size_mm: 36, wr_m: 100, movement: "Automatic (ST2130)", fidelity: 82, priceSource: "addiesdivewatches.com", priceDate: "2026-08-30", amazon: true, verified: "2026-08-30", note: "the strongest buyable Explorer homage in the field right now: a genuine ST2130 automatic, sapphire bubble crystal and 36mm — the same case size as the modern 124270, which most homages miss by wearing 39 or 40. Listed at $149.99 and in stock on Addiesdive's own store at our 08-30 check. Reference corrected 2026-08-30: this watch was filed here as AD2035 until Addiesdive's own catalogue was read end to end — AD2035 is a different product entirely, a 39mm Ronda 515 quartz GMT at $89. The 36mm ST2130 bubble-crystal Explorer style is AD2556" },
        { name: "AD2515 Explorer Style", house: "Addiesdive", priceUSD: 79, size_mm: 36, wr_m: 100, movement: "Quartz (Seiko VH31 sweep)", fidelity: 72, priceSource: "addiesdivewatches.com", priceDate: "2026-09-22", amazon: true, verified: "2026-09-22", note: "the budget entry, and honest about what it is: a VH31 quartz with a sweeping seconds hand rather than an automatic, so it ticks four times a second instead of eight and needs a battery. Right size, right 3-6-9 dial, half the money of anything mechanical here. Ships from a US warehouse. Re-read 2026-09-22: $79 and in stock on the U.S.-warehouse listing, with the specification block giving 36mm without the crown and 100m, and naming the movement a Japan VH31 quartz with sweeping seconds" },
      ]
    },
    {
      ...
      homages: [
        { name: "PD-1701", house: "Pagani Design", priceUSD: 125, size_mm: 40, wr_m: 100, movement: "Meca-quartz (Seiko VK63)", fidelity: 80, priceSource: "amazon.com", priceDate: "2026-09-11", asin: "B0DZBVM35F", amazon: true, verified: "2026-08-13", note: "the one unambiguous Moonwatch homage in the budget tier — Pagani's own catalog files it as a nod to the Speedmaster, with the stepped dial, three registers and a moulded tachymeter bezel; 40mm against the original's 42 and double its water resistance, but a meca-quartz hybrid rather than a hand-wound chronograph" },
        { name: "SN0103-G-JS", house: "San Martin", priceUSD: 349, size_mm: 38.5, wr_m: 100, movement: "Manual chronograph (Seagull ST1901)", fidelity: 72, priceSource: "sanmartinwatches.com", priceDate: "2026-09-21", amazon: false, merchant: "sanmartin", merchantUrl: "https://sanmartinwatches.com/shop/sn0101-sn0110/sn0103/sn0103-g-js/", availability: "sold-out", direct: true, verified: "2026-09-21", note: "a genuine hand-wound column-wheel chronograph and the best build here — but read the layout before buying: San Martin calls it the SM57 and it is bicompax with straight lugs, following the 1957 Speedmaster ancestor rather than the three-register Moonwatch, which is why it scores below the cheaper Pagani against this reference. Sold out in every variant on San Martin's own store at our 2026-09-21 check (all ten configurations out of stock), still listed at $349 on sale from a $499 list price." }
      ]
    },
    {
      ...
      homages: [
        ...
        { name: "AD2106", house: "Addiesdive", priceUSD: 130, size_mm: 42, wr_m: 200, movement: "Automatic (Seiko NH35)", fidelity: 71, priceSource: "amazon.com", priceDate: "2026-09-11", asin: "B0F7Y14PJT", amazon: true, direct: true, verified: "2026-08-21", note: "Addiesdive titles this one Seamaster itself, and it gets the easy things right — the original's exact 42mm, a ceramic bezel, sapphire with AR and a Seiko auto for the least money here; but it misses the two cues the Seamaster is actually known for. The dial is a fine even grain, not the laser-cut wave, there is no helium valve at 10, and the date sits at 3 where the original puts it at 6" },
      ]
    },
    {
      ...
      homages: [
        { name: "PD-1728", house: "Pagani Design", priceUSD: 130, size_mm: 40, wr_m: 100, movement: "Automatic (Seagull ST6)", fidelity: 80, priceSource: "paganidesign.com", priceDate: "2026-08-13", asin: "B0BHT51BN5", amazon: true, amazonPriceUSD: 116.99, amazonPriceDate: "2026-09-22", availability: "in-stock", availabilityDate: "2026-09-22", availabilitySource: "amazon.com", verified: "2026-08-13", note: "the porthole case, ears and grooved dial in steel with an integrated bracelet — the reason Pagani sells out; wears close to the original's 40mm" },
        { name: "SN076-G", house: "San Martin", priceFrom: true, priceUSD: 299, size_mm: 42, wr_m: 200, movement: "Automatic (PT5000 / SW200)", fidelity: 82, priceSource: "sanmartinwatches.com", priceDate: "2026-09-05", amazon: false, direct: true, directUrl: "https://sanmartinwatches.com/shop/sn071-sn080/sn076/sn0076g/", availability: "in-stock", availabilityDate: "2026-09-23", availabilitySource: "sanmartinwatches.com", availabilityConfig: "PT5000 \u00b7 Matte Light Blue \u00b7 no date window", availabilityConfigsInStock: 1, availabilityConfigsTotal: 10, availabilityExcludes: "every SW200 and every date-window configuration", verified: "2026-09-21", note: "the case finishing and bracelet taper the budget versions miss, on a Swiss-class PT5000 or SW200 rather than a Seiko auto, with a genuine 200m rating; it wears 42mm against the original's 40mm, which is the one thing it does not get right. Back in stock on San Martin's own store at our 2026-09-05 check, relisted as SN0076G-NEW from $299 (currently on sale from a $445 top configuration); the Pagani below remains the cheaper buy." },
        { name: "S466 Heritage", house: "Sugess", priceUSD: 259, size_mm: 38.5, wr_m: 50, movement: "Automatic (Miyota 9015)", fidelity: 75, priceSource: "sugesswatch.com", priceDate: "2026-08-13", asin: "B0GGSJRV2J", amazon: true, verified: "2026-08-13", note: "the porthole octagonal case and integrated bracelet on a genuine hi-beat Miyota 9015, in a 9mm case that respects the original's slimness; the day display and enamel or MOP dial options stray from the 5711's horizontal grooves, and 50m is well short of the original's 120m" },
        { name: "Automatic 1983 E-Line", house: "Timex", priceUSD: 279, size_mm: 34, wr_m: 50, movement: "Automatic (Miyota 8215)", fidelity: 60, priceSource: "timex.com", priceDate: "2026-08-13", asin: "B0FLW6TL7J", amazon: true, verified: "2026-08-13", note: "not a Nautilus copy — a revival of Timex's own 1983 TV-dial design that lands in the same rounded-porthole territory, from a mainstream brand with a real warranty; 34mm and an acrylic crystal, so treat it as the character buy" },
        { name: "PRX 40mm (T137.407.11.051.01)", house: "Tissot", priceUSD: 850, size_mm: 40, wr_m: 100, movement: "Swiss automatic (Powermatic 80)", fidelity: 68, priceSource: "tissotwatches.com", priceDate: "2026-08-27", asin: "B0DCWXJM74", amazon: true, verified: "2026-08-27", note: "not a Nautilus copy — Tissot's own 1978 design, revived, and the watch most often bought instead of chasing one. It shares the thing that matters, a bracelet genuinely integrated into the case, plus a textured dial and a 40mm width that matches the 5711 exactly. The case is a rounded tonneau with no porthole ears, so the silhouette is cousin rather than copy. In return: a Swiss automatic with an 80-hour reserve, sapphire, 100m and a real warranty — the only watch here that is a destination rather than a substitute" }
      ]
    },
    {
      ...
      homages: [
        ...
        { name: "SN013-G", house: "San Martin", priceUSD: 460, size_mm: 38.5, wr_m: 100, movement: "Automatic (Miyota 9015)", fidelity: 83, priceSource: "amazon.com", priceDate: "2026-08-30", asin: "B09PYXWYDZ", amazon: true, direct: false, amazonPriceUSD: 459.90, amazonPriceDate: "2026-09-22", availability: "in-stock", availabilityDate: "2026-09-22", availabilitySource: "amazon.com", verified: "2026-08-30", note: "the closest bracelet integration in the field and a 9.5mm case that actually wears like the original; San Martin calls the bezel a Royal Oak/Nautilus hybrid rather than a straight copy, and at 38.5mm it is the smallest here. San Martin has discontinued it: a 2026-08-30 search of its own store returns SN0130/0133/0134/0138 and no SN013 at all, so the $335 direct price this row used to quote is no longer buyable anywhere. Amazon is now the only source, at $459.90 — a third more than it cost when San Martin still listed it, which is the honest reason to consider the newer references above before this one." },
        ...
        { name: "PRX 40mm (T137.407.11.051.01)", house: "Tissot", priceUSD: 850, size_mm: 40, wr_m: 100, movement: "Swiss automatic (Powermatic 80)", fidelity: 62, priceSource: "tissotwatches.com", priceDate: "2026-08-27", asin: "B0DCWXJM74", amazon: true, verified: "2026-08-27", note: "the integrated-bracelet alternative rather than a Royal Oak homage, and the distinction is the point. It gets the case-to-bracelet integration and a textured dial, but there is no octagonal bezel and no exposed screws — the two cues that actually say Royal Oak. Buy it if what you wanted was the 1970s integrated-steel-sports idea done properly: Swiss automatic, 80-hour reserve, sapphire, 100m, real warranty" }
      ]
    },
    {
      ...
      homages: [
        { name: "SN008-G", house: "San Martin", priceFrom: true, priceUSD: 326, size_mm: 40, wr_m: 200, movement: "Automatic (PT5000 / SW200)", fidelity: 85, priceSource: "sanmartinwatches.com", priceDate: "2026-08-13", amazon: false, direct: true, verified: "2026-09-21", note: "snowflake hands and a gilt dial that track the BB58 closely, on a Swiss-class movement; it wears 40mm against the original's 39, and the cheaper Seiko-powered version is a separate reference, the SN008-G-B. Sold out in every variant on San Martin's own store at our 2026-08-27 check." },
        { name: "AD2043", house: "Addiesdive", priceUSD: 149, size_mm: 39, wr_m: 200, movement: "Automatic (Seiko NH35)", fidelity: 81, priceSource: "addiesdivewatches.com", priceDate: "2026-08-19", amazon: true, direct: true, verified: "2026-08-19", note: "matches the original on both numbers that matter — 39mm and a real 200m — and is the only automatic here that does, with snowflake hands Addiesdive names on its own product page, sapphire with AR and an aluminium 120-click bezel; the giveaway is height, 14.5mm over the crystal, so it stacks noticeably taller than the slim diver it follows, and the white dial is Addiesdive's own idea rather than the original's" },
        { name: "OCT-0025 BB54", house: "Octopus Kraken", priceUSD: 245, size_mm: 37, wr_m: 200, movement: "Automatic (PT5004)", fidelity: 80, priceSource: "watchdives.com", priceDate: "2026-08-28", asin: "B0GL883DJC", amazon: true, verified: "2026-08-28", note: "worth reading the reference before buying: this is a BB54 homage, not a BB58 — 37mm against the 58's 39, tracking the smaller 2023 Tudor rather than the one this page is about. It is the better-built watch of the two Kraken options, on a Swiss-class PT5004 with snowflake hands and a domed sapphire" },
        { name: "AD2044 BB58 GMT", house: "Addiesdive", priceUSD: 99, size_mm: 39, wr_m: 200, movement: "Quartz GMT (Ronda 515-24H)", fidelity: 74, priceSource: "addiesdivewatches.com", priceDate: "2026-09-22", asin: "B0FDWM3HRX", amazon: true, verified: "2026-09-22", note: "the GMT reading of the shape at 39mm — the right size, snowflake hands, and a second time zone the real BB58 does not have. Re-read on Addiesdive's own store on 2026-09-22, and the water resistance recorded here was wrong: the specification block reads 20Bar = 200 meters on all three of the store's AD2044 listings, not the 100m this row carried, so it matches the original's 200m rather than falling short of it. The page names the movement a Swiss Ronda 515-24H quartz. What separates it from the original is therefore the movement type and not the depth rating — quartz rather than automatic, which is why it reads as the travel-watch answer rather than the dive-watch one. $99 and in stock on the U.S.-warehouse listing at that check" },
      ]
    },
    {
    ...
    },
    {
      ...
      homages: [
        ...
        { name: "SN095-G-DA", house: "San Martin", priceUSD: 218, size_mm: 44.5, wr_m: 100, movement: "Automatic (YN55A)", fidelity: 82, priceSource: "sanmartinwatches.com", priceDate: "2026-08-13", amazon: false, merchant: "sanmartin", merchantUrl: "https://sanmartinwatches.com/shop/sn091-sn0100/sn095/sn095-g-da/", availability: "sold-out", direct: true, verified: "2026-09-21", note: "the oversized onion crown and 3D Arabic numerals at a properly large 44.5mm — the only watch here that does not shrink the design to fit a normal wrist. Stock checked 2026-09-21 and the answer is worse than it looks: San Martin offers this reference with either the YN55 automatic or the hand-wound ST3621, and BOTH YN55 configurations are out of stock. The single buyable configuration is the ST3621 with logo, which is a manual wind, not the automatic this row tracks" },
      ]
    },
    {
    ...
    },
    {
      ...
      homages: [
        { name: "EXD-40", house: "Watchdives", priceUSD: 139, size_mm: 40, wr_m: 200, movement: "Quartz (Seiko VH31 sweep)", fidelity: 71, priceSource: "watchdives.com", merchant: "watchdives", merchantUrl: "https://watchdives.com/products/watchdives-40mm-exd-titanium-diver-watch?ref=yupgbgih", amazonPriceUSD: 159.98, amazonPriceDate: "2026-09-04", priceDate: "2026-08-13", asin: "B0G3X25VTP", amazon: true, direct: true, verified: "2026-08-13", note: "grade-2 titanium with a 200m rating and sapphire for well under the field — but it is a VH31 sweep-second quartz, not an automatic, which is the honest gap against a Pelagos; also sold as the 38mm EXD-38" },
        { name: "SN0111-T-A1", house: "San Martin", priceFrom: true, priceUSD: 389, size_mm: 40, wr_m: 300, movement: "Automatic (PT5000 / SW200)", fidelity: 85, priceSource: "sanmartinwatches.com", priceDate: "2026-09-05", amazon: false, direct: true, verified: "2026-09-21", note: "grade-5 titanium with a helium escape valve and ceramic bezel, matching the original's 300m — the closest affordable Pelagos, though it wears 40mm against the original's 42 and there is no Seiko-powered version. Sold out in every variant on San Martin's own store at our 2026-09-05 recheck ($389–$568 range base still listed)." }
      ]
    },
    {
      ...
      homages: [
        ...
        { name: "WD16570 V2 Pioneer", house: "Watchdives", priceUSD: 229, size_mm: 37, wr_m: 100, movement: "Automatic GMT (Seiko NH34)", fidelity: 81, priceSource: "watchdives.com", priceDate: "2026-08-13", amazon: true, merchant: "watchdives", merchantUrl: "https://watchdives.com/products/watchdives-wd16570-nh34-gmt-watch-v2?ref=yupgbgih", availability: "sold-out", direct: true, verified: "2026-09-21", note: "named straight after the 16570 reference and the closest dial in the field — enamel polar-white with the orange GMT hand, fixed 24h steel bezel and sapphire; it wears a compact 37mm against the original's 42mm, which is the one big honest gap. Sold out new on Watchdives' own store when we re-checked on 18 Aug 2026 — re-checked 2026-09-04 and all five variants are still out of stock, so this row is marked sold-out and its link goes to the exact product page rather than pretending there is a buy; the 38mm WD16570B is the live sibling, $189 on 2026-09-04" },
        { name: "PD-1693", house: "Pagani Design", priceUSD: 148, size_mm: 42, wr_m: 200, movement: "Automatic GMT (Pearl DG5833A)", fidelity: 77, priceSource: "paganidesign.com", priceDate: "2026-08-30", amazon: false, direct: true, directUrl: "https://paganidesign.com/products/pd-1693", availability: "sold-out", verified: "2026-08-30", note: "the freccione orange 24-hour hand and fixed bezel at a fraction of the money, with sapphire and a real 200m rating; it wears 42mm, a size up on the modern original and two on the vintage one it echoes. Pagani's official page identifies the movement as a Pearl DG5833A and shows every variant sold out; Amazon search did not surface PD-1693. The link now opens that exact official availability page instead of an unrelated PD-1645 search result and is not affiliated." },
    ...
    },
    {
      ...
      homages: [
        { name: "PD-1651", house: "Pagani Design", priceUSD: 122, size_mm: 40, wr_m: 100, movement: "Automatic (Seiko NH35)", fidelity: 82, priceSource: "paganidesign.com", priceDate: "2026-08-13", asin: "B0B3TFV9T9", amazon: true, verified: "2026-08-13", note: "one of the visually closest Yacht-Master homages — bidirectional bezel, sunburst dial, oyster bracelet — with a Seiko auto for well under a hundred; out of stock on Pagani's own store at our last check" },
    ...
    },
    {
      ...
      homages: [
        ...
        { name: "WD1965 V2", house: "Watchdives", priceUSD: 104, size_mm: 38, wr_m: 200, movement: "Quartz (Seiko VH31 sweep)", fidelity: 72, priceSource: "watchdives.com", priceDate: "2026-09-04", amazon: true, merchant: "watchdives", merchantUrl: "https://watchdives.com/products/watchdives-wd1965-vh31-62mas-dive-watch?ref=yupgbgih", direct: true, verified: "2026-09-04", note: "the vintage-diver silhouette with a domed sapphire and a real 200m rating at the lowest price here; two honest caveats — it is a VH31 sweep-second quartz rather than an automatic, and the case is 38mm against the reissue's 40mm" }
      ]
    },
    {
    ...
    },
    {
      ...
      homages: [
        { name: "PD-1733", house: "Pagani Design", priceUSD: 115, size_mm: 40, wr_m: 100, movement: "Automatic (Miyota 8215)", fidelity: 78, priceSource: "amazon.com", priceDate: "2026-09-11", asin: "B0B5G36R1R", amazon: true, verified: "2026-09-21", note: "the one widely sold Milgauss homage with the green-tinted sapphire — the cue that says Milgauss before anything else. Both cited pages describe it: Amazon calls it a green synthetic sapphire, and Pagani's own page says the seconds hand and green crystal give the watch its character — in a marketing block rather than the specification table, which lists only sapphire, which is why an earlier read of this row missed it. What Pagani's own sheet does carry, re-read 2026-09-21: a 316L case with a screw-down crown and 100m, at 40mm — though Amazon's spec block says 39.7mm for the same watch, so read the diameter as 40mm give or take a third of a millimetre depending on whose sheet you trust. The Miyota 8215 is a step below the NH35 the brand uses elsewhere and hacks only on some examples; Pagani's sheet and Amazon's own description both name the 8215, and Amazon's browser title saying NH35A is a stale title rather than a second source. Pagani's own store lists it at $189.99, down from $204.24, and sold out in both colours on 2026-09-21. That is the US price: paganidesign.com serves a different price per market, and its default locale says $174.95 — read the /en-us/ one for a US reader, which is what this row is; the Amazon listing that carries the reference in its title is $114.99, so that is where the link lands and the price comes from. The orange lightning-bolt seconds hand is described on the Amazon listing and scored under dial and handset, the heaviest axis; the bezel is described in text on neither page and is judged from maker photos, which the rubric allows." }
      ]
    }
  ]
};
