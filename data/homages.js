  ...
  originals: [
    ...
    },
    {
      ...
      homages: [
        ...
        { name: "SN0103-G-JS", house: "San Martin", priceUSD: 349, size_mm: 38.5, wr_m: 100, movement: "Manual chronograph (Seagull ST1901)", fidelity: 72, priceSource: "sanmartinwatches.com", priceDate: "2026-09-07", amazon: false, direct: true, verified: "2026-09-07", note: "a genuine hand-wound column-wheel chronograph and the best build here — but read the layout before buying: San Martin calls it the SM57 and it is bicompax with straight lugs, following the 1957 Speedmaster ancestor rather than the three-register Moonwatch, which is why it scores below the cheaper Pagani against this reference. Back in stock on San Martin's own store at our 2026-09-07 check, on sale at $349 from a $499 list price." }
      ]
    },
    {
