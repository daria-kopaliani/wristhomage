...
window.HOMAGE_DATA = {
  originals: [
    ...
    },
    {
      ...
      homages: [
        { name: "EXD-40", house: "Watchdives", priceUSD: 139, size_mm: 40, wr_m: 200, movement: "Quartz (Seiko VH31 sweep)", fidelity: 71, priceSource: "watchdives.com", priceDate: "2026-08-13", asin: "B0G3X25VTP", amazon: true, direct: true, verified: "2026-08-13", note: "grade-2 titanium with a 200m rating and sapphire for well under the field — but it is a VH31 sweep-second quartz, not an automatic, which is the honest gap against a Pelagos; also sold as the 38mm EXD-38" },
